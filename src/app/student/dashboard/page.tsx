            ...
            <div className="flex justify-center space-x-50">
                ...
                <div className="flex flex-col h-120 w-85 border-2 border-gray-200 border-opacity-25 bg-white shadow-2xl shadow-black-80">
                    <div className="flex justify-center">
                        <svg width="200" height="200" viewBox="0 0 250 250" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M83.3334 166.667H166.667V187.5H83.3334V166.667ZM83.3334 125H166.667V145.833H83.3334V125ZM145.833 20.8334H62.5001C51.0417 20.8334 41.6667 30.2084 41.6667 41.6667V208.333C41.6667 219.792 50.9376 229.167 62.3959 229.167H187.5C198.958 229.167 208.333 219.792 208.333 208.333V83.3334L145.833 20.8334ZM187.5 208.333H62.5001V41.6667H135.417V93.75H187.5V208.333Z" fill="#28A745"/>
                        </svg>
                    </div>      
                    ...
                    <div className="flex justify-center">
                        <svg width="48" height="48" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="30" cy="30" r="28.5" stroke="#28A745" strokeWidth="3"/>
                            <path fillRule="evenodd" clipRule="evenodd" d="M36.9283 31.1849L27.5 40.6132L25.1433 38.2566L33.3933 30.0066L25.1433 21.7566L27.5 19.3999L36.9283 28.8282C37.2408 29.1408 37.4163 29.5646 37.4163 30.0066C37.4163 30.4485 37.2408 30.8724 36.9283 31.1849Z" fill="#28A745"/>
                        </svg>
                    </div>
                </div>
                </button>
                ...
                <div className="flex flex-col h-120 w-85 border-2 border-gray-200 border-opacity-25 bg-white shadow-2xl shadow-black-80">
                    ...
                    <div className="flex justify-center">
                        <svg width="48" height="48" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="30" cy="30" r="28.5" stroke="#007BFF" strokeWidth="3"/>
                            <path fillRule="evenodd" clipRule="evenodd" d="M36.9286 31.1849L27.5002 40.6132L25.1436 38.2566L33.3936 30.0066L25.1436 21.7566L27.5002 19.3999L36.9286 28.8282C37.241 29.1408 37.4165 29.5646 37.4165 30.0066C37.4165 30.4485 37.241 30.8724 36.9286 31.1849Z" fill="#007BFF"/>
                        </svg>
                    </div>
                </div>
                </button>
