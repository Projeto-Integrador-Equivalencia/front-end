    ...
    // GET /students/{id}
    export async function getStudentById(id: number, token: string): Promise<Student> {
    ...
    export async function getStudentByCpf(cpf: string, token: string): Promise<Student> {
    ...
    export async function getStudentByEmail(email: string, token: string): Promise<Student> {
